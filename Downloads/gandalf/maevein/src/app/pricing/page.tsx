                ...
                <header className="border-b border-white/5">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                        <Link href="/" className="flex items-center gap-3 group w-fit">
                            ...
                            <h1 className="font-bold text-white text-md leading-tight">Knowledge Guardian</h1>
                        </Link>
                    </div>
                </header>
                ...
                <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-20">
                    ...
                    >
                        ...
                        <p className="text-white/50 text-lg mb-8">
                            Join over 1,000+ guardians. Unlock all STEM modules and AI interactions.
                        </p>
