...
const FAQ_DATA = [
  { q: "What is Knowledge Guardian?", a: "Knowledge Guardian is an educational AI game where you prove your subject knowledge by interacting with AI guardians. Each guardian protects a secret answer, and you must demonstrate understanding to unlock it." },
  { q: "How does the game work?", a: "Choose a subject module, then chat with the AI guardian. The guardian will challenge you with riddles and prompts. Demonstrate your knowledge to discover the secret, then submit your answer to advance." },
  { q: "Is it really free?", a: "Yes! During the beta period, Knowledge Guardian is 100% free. We believe in making quality education accessible to everyone." },
  ...
  { q: "Can teachers use this for their classes?", a: "Absolutely! Teachers can use Knowledge Guardian as a supplementary learning tool. Students learn by actively demonstrating knowledge rather than passively reading." },
  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              Can You <span className="gradient-text">Outsmart</span><br />the Guardian?
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Challenge AI guardians by proving your knowledge in Chemistry, Biology, Physics, Python, Gen AI & DSA. Learn by doing, not memorizing.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Brain, title: "Question Guardian", desc: "Chat with the AI guardian to prove your knowledge" },
            ...
            {MODULES.map((mod, i) => (
              <motion.div key={mod.id} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i}>
                <Link to="/signup" className="glass-card p-8 rounded-2xl block group">
                  ...
                  <p className="text-sm text-primary mb-3">{mod.guardian}</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-3xl md:text-4xl font-bold text-center mb-16">
            Why <span className="gradient-text">Knowledge Guardian</span>?
          </motion.h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Zap, title: "Progressive Difficulty", desc: "7 levels per subject, from beginner to expert" },
              { icon: Brain, title: "AI Validation", desc: "Intelligent guardians adapt to your approach" },
        ...
        <div className="max-w-lg mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
            <div className="glass-card p-8 md:p-10 rounded-2xl">
              ...
              <p className="text-center text-muted-foreground mb-8">Be among the first to challenge the guardians</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <label className="flex items-center gap-3 text-sm text-muted-foreground cursor-pointer">
                    <input
                      ...
                      required
                    />
                    I agree to receive updates about Knowledge Guardian
                  </label>
      ...
      <footer className="py-12 px-4 border-t border-border/50">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold gradient-text">Knowledge Guardian</span>
          </div>
          ...
          <p className="text-sm text-muted-foreground">© 2026 Knowledge Guardian. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
