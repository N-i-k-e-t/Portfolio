...
export function ChatInterface({ level, moduleId, accentColor, maeveinName, onBack }: ChatInterfaceProps) {
    ...
    // Add maevein greeting on mount
    useEffect(() => {
        setMessages([
            {
                id: 'greeting',
                role: 'assistant',
                content: level.maeveinGreeting,
                timestamp: new Date(),
            },
        ]);
    }, [level.maeveinGreeting]);
        ...
        <div className="flex flex-col h-full relative">
            ...
            <div className="glass-dark px-4 py-3 flex items-center gap-3 z-10 flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-white text-sm truncate">{maeveinName}</h3>
